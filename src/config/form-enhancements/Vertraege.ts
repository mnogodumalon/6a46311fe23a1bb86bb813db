// Auto-generated. Per-entity form-enhancements config for "Verträge".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["vertragsbezeichnung", "vertragsnummer", "kategorie", "status", "partner", "ansprechpartner", "jahresvolumen", {"row": ["startdatum", "enddatum"]}, "kuendigungsfrist", "kuendigungsdatum", "notizen"],
  defaults: {
    'status': { kind: 'lookup', key: 'aktiv', label: 'Aktiv' },
    'startdatum': { kind: 'today' },
    'enddatum': { kind: 'todayOffset', days: 365 },
  },
  computed: {},
};
