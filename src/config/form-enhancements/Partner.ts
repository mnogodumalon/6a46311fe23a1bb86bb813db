// Auto-generated. Per-entity form-enhancements config for "Partner".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["firmenname", "branche", {"row": ["strasse", "hausnummer"], "cols": "2fr 1fr"}, {"row": ["postleitzahl", "ort"], "cols": "1fr 2fr"}, "telefon", "email", "webseite", "notizen"],
  defaults: {},
  computed: {},
};
